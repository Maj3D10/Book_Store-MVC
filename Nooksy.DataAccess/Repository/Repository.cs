...
namespace Nooksy.DataAccess.Repository
{
    public class Repository<T> : IRepository<T> where T : class
    {
        ...
        public Repository(AppDbContext db)
        {
            ...
            _db.Products.Include(b => b.Category).Include(d=>d.CategoryId);
        }
        ...
        public IEnumerable<T> GetAll(System.Linq.Expressions.Expression<Func<T, bool>>? filter, string? includeProperties = null, Func<IQueryable<T>, IOrderedQueryable<T>>? orderBy = null)
        {
